    ...
    <div className="relative z-30 px-5 pb-8 pt-8 sm:px-6 lg:px-12 lg:pb-10 lg:pt-12">
      <div className="flex flex-col md:flex-row items-start justify-between gap-8">
        <div>
          ...
          <p className="max-w-xl text-body-md mt-1">
            Löst gemeinsam 200 Fälle, erreicht tägliche Ziele und kämpft um die
            Spitze des Leaderboards. Der erste Platz wird belohnt.
          </p>
        </div>
