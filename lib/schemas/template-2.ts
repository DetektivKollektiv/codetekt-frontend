    ...
    fields: [
      {
        ...
        is_required: [
          { value: 'neutral', field_id: 'content_type', operator: '===' },
        ],
        is_shown: [
          { value: 'neutral', field_id: 'content_type', operator: '===' },
        ],
      ...
      },
      {
        ...
        type: 'traffic-light',
        question:
          'Die Grammatik und Rechtschreibung der Nachricht sind fehlerfrei.',
        options: [
          {
            id: 'traffic-light-opt-1',
            value: 0,
      ...
      },
      {
        ...
        type: 'traffic-light',
        question:
          'Es wird angegeben, wenn Informationen unsicher, vorläufig oder umstritten sind.',
        options: [
          {
            id: 'traffic-light-opt-1',
            value: 0,
      ...
      },
      {
        ...
        type: 'traffic-light',
        question:
          'Es werden keine entscheidenden und relevanten Informationen ausgelassen, die das Gesamtbild verändern würden.',
        options: [
          {
            id: 'traffic-light-opt-1',
            value: 0,
      ...
      },
      {
        ...
        type: 'traffic-light',
        question:
          'Der Artikel enthält keine offensichtliche logische Fehlschlüsse oder argumentative Sprünge.',
        options: [
          {
            id: 'traffic-light-opt-1',
            value: 0,
      ...
      },
      {
        ...
        type: 'traffic-light',
        question:
          'Der Artikel ist frei von Sponsoring, Advertorial-Charakter und vebirgt keine versteckte Werbeabsicht.',
        options: [
          {
            id: 'traffic-light-opt-1',
            value: 0,
