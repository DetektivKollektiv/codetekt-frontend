...
export const submittedReviewAnswerSchema = z
  ...
  .refine(
    (data) => {
      ...
      if (data.additional_rating !== null && data.additional_rating < 4) {
        return (
...
// Export types
export type SubmittedReviewAnswerData = z.infer<
  typeof submittedReviewAnswerSchema
>;
export type InProgressReviewAnswerData = z.infer<
